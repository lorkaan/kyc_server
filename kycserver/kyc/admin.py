...
from .models import KYCRecord, KYCStatus, KycAnswer, KycAnswerOption, KycCondition, KycQuestion, KycQuestionGroup, ReferenceSet, ReferenceValue, RelationshipRole, RiskScore
...
admin.site.register(KycCondition)
admin.site.register(KycQuestionGroup)
