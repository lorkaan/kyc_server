"""
Django settings for kycserver project.
...
from utils.read_env import EnvironVarLoader
import os
...
SECRET_KEY = 'django-insecure-gzi+fy8r+w*xqzbx*iq3!#3v@g5p(s6t)e&ml-qx#_*4y=#p2l'
...
WSGI_APPLICATION = 'kycserver.wsgi.application'
